...
import parser_1
import preprocess_message_user
import find_file_paths

file_path = 'sample_logs_user.txt'
...
df = preprocess_message_user.preprocess_message(df)
print(df.head())
print(df.columns)
...
# columns host, ident, pid, process, user_ns must be one-hot encoded